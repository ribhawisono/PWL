...
if (isset($_POST['submit'])) {
    ...
    $nim     = htmlspecialchars(trim($_POST['nim_mhs']));
    $nama    = htmlspecialchars(trim($_POST['nama_mhs']));
    $jurusan = htmlspecialchars(trim($_POST['jurusan_mhs']));

    $sql      = "INSERT INTO mahasiswa (nim_mhs, nama_mhs, jurusan_mhs) VALUES ('$nim', '$nama', '$jurusan')";
...
<head>
    ...
    <title>Gagal Menyimpan · PERT13</title>
...
<div class="wrapper">
    <div class="form-card" style="text-align:center;padding:2.5rem;">
        ...
        <div class="page-title" style="margin-bottom:.5rem;">Gagal Menyimpan Data</div>
        ...
        <div style="margin-top:1.5rem;display:flex;gap:.75rem;justify-content:center;">
            <a href="tambah_mahasiswa.php" class="btn btn-primary">← Kembali ke Form</a>
