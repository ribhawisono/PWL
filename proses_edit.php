...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE mahasiswa SET nama_mhs = '$nama', jurusan_mhs = '$jurusan' WHERE nim_mhs = '$nim'";
...
<head>
    ...
    <title>Gagal Mengubah · PERT13</title>
...
<div class="wrapper">
    <div class="form-card" style="text-align:center;padding:2.5rem;">
        ...
        <div class="page-title" style="margin-bottom:.5rem;">Gagal Mengubah Data</div>
        ...
        <div style="margin-top:1.5rem;display:flex;gap:.75rem;justify-content:center;">
            <a href="javascript:history.back()" class="btn btn-warning">← Kembali ke Form</a>
